...
As a hypertext developer it is nice to stay in an HTML headspace. This Go code generator helps you do that.
...
- *[new]* It can do static type checking of your template actions
